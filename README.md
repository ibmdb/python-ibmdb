...
### *Updated ibm_db*
  ...
  Note : 2.0.6 release is currently not available in https://pypi.python.org/pypi/ibm_db/ and ibm_db 2.0.5.1 will be replaced shortly with the new release ibm_db 2.0.6.  
